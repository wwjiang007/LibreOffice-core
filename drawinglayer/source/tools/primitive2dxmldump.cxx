    ...
    for (size_t i = 0; i < rPrimitive2DSequence.size(); i++)
    {
        ...
        switch (nId)
        {
            ...
            case PRIMITIVE2D_ID_METAFILEPRIMITIVE2D:
            {
                ...
                drawinglayer::primitive2d::VisitorParameters aVisitorParametersCopy(
                    aVisitorParameters);
                aVisitorParametersCopy.resetViewInformation();
                rMetafilePrimitive2D.get2DDecomposition(aPrimitiveContainer,
                                                        aVisitorParametersCopy);
            ...
            case PRIMITIVE2D_ID_SDRRECTANGLEPRIMITIVE2D:
            {
                ...
                drawinglayer::primitive2d::Primitive2DContainer aPrimitiveContainer;
                pBasePrimitive->get2DDecomposition(aPrimitiveContainer, aVisitorParameters);
                decomposeAndWrite(aPrimitiveContainer, rWriter);
                rWriter.endElement();
                break;
            }
